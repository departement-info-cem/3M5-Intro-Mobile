...
Au besoin, tu peux réviser les notions sur Git [ici](../02-recettes/git.md).
...
Il y a un examen théorique au prochain cours. 

Tu trouveras le formatif A26 **[ici](https://github.com/departement-info-cem/3M5-Intro-Mobile/blob/main/web/static/A26-intra-formatif-papier.md)**.

Tu trouveras le formatif A25 **[ici](https://github.com/departement-info-cem/3M5-Intro-Mobile/blob/main/web/static/A25-intra-formatif-papier.md)**.
