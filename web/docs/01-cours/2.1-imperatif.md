...
- Focus sur le [null safety](https://en.wikipedia.org/wiki/Null_pointer#History) (*[Tutoriel sur l'utilisation du Null safety](https://kotlinlang.org/docs/kotlin-tour-null-safety.html)*)
- Focus sur la différence entre *[val et var](https://kotlinlang.org/docs/basic-syntax.html#variables)*
- Focus sur les *[types](https://kotlinlang.org/docs/types-overview.html)*
...
2. Visionner la vidéo sur la programmation impérative en Kotlin.
3. Parcourir le ***[tutoriel sur les fonctions](https://kotlinlang.org/docs/kotlin-tour-functions.html)***.
