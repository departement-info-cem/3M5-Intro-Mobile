...
1. Créer un repo GitHub privé 3M5-NomDeFamille-Prenom pour vos exercices, notes etc.
...
- **Indice 2** : Puisque le triangle devrait se retrouver dans la String qui est retournée par la fonction, il ne devrait y avoir aucun `print` dans la fonction.
