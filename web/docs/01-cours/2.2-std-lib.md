...
1. Parcourir la documentation de la librairie standard de Kotlin sur les ***[Collections](https://kotlinlang.org/docs/collections-overview.html)*** (*List, Set, Map*). Vous pouvez également passer à travers ce ***[tutoriel sur les collections](https://kotlinlang.org/docs/kotlin-tour-collections.html)***.
2. Regarder les vidéos de théorie.
3. Parcourir le ***[tutoriel sur les classes](https://kotlinlang.org/docs/kotlin-tour-classes.html)***
