...
Vous êtes fortement encouragés à utiliser des [librairies](../cours/2.2-std-lib) vues dans le cours (ou pas) pour aider :
...
&#8203;<Highlight color="tip">3 points</Highlight> Tu dois utiliser le repo GitHub que ton prof t'a envoyé.
...
&#8203;<Highlight color="tip">2 point</Highlight>
Prévois et implémente un plan de test permettant de tester toutes les configurations et situations possibles pour la validation des arguments du programme.
...
- tenter de télécharger la page
  ...
  - &#8203;<Highlight color="tip">1 point</Highlight> Prévois et implémente un plan de test pour cette fonctionnalité.
...
```
https://info.cegepmontpetit.ca/3M5-Intro-Mobile/z/index.html
htps://info.cegepmontpetit.ca/3M5-Intro-Mobile/z/1.html
https://info.cegepmontpetit.ca/3M5-Intro-Mobile/z/1.html
https://info.cegepmontpetit.ca/3M5-Prog3/z/sub/5.html
```

On devrait obtenir la trace suivante :

```
Am   https://info.cegepmontpetit.ca/3M5-Intro-Mobile/z/index.html
URL malformée : htps://info.cegepmontpetit.ca/3M5-Intro-Mobile/z/1.html
Stram   https://info.cegepmontpetit.ca/3M5-Intro-Mobile/z/1.html
Pas de page à l'adresse : https://info.cegepmontpetit.ca/3M5-Prog3/z/sub/5.html
```

### Collecte des courriels pendant l'exploration

&#8203;<Highlight color="tip">1 point</Highlight>
Le programme collecte les adresses courriels valides contenues dans chaque page.
...
&#8203;<Highlight color="tip">1 point</Highlight>
Prévois et implémente un plan de test pour cette fonctionnalité.
...
https://info.cegepmontpetit.ca/3M5-Intro-Mobile/z/index.html
https://info.cegepmontpetit.ca/3M5-Intro-Mobile/z/1.html
https://info.cegepmontpetit.ca/3M5-Intro-Mobile/z/2.html
https://info.cegepmontpetit.ca/3M5-Intro-Mobile/z/sub/3.html
https://info.cegepmontpetit.ca/3M5-Intro-Mobile/z/sub/aaa/index.html
https://info.cegepmontpetit.ca/3M5-Intro-Mobile/z/sub/aaa/page5.html
```
